    ...
    número como a duplicação. Retorne a duplicação considerada.
        Requisitos:
            ...
            Exemplo:
                ...
                Tem que retornar o primeiro duplicado que achar.
...
def procurando_duplicadas(lista):
    lista_temp = []
    retornar_final = -1

    for elemento in lista:
        if elemento in lista_temp:
            retornar_final = elemento
            break
        lista_temp.append(elemento)

    return retornar_final

for elemento in lista_de_listas_de_inteiros:
    print(elemento, procurando_duplicadas(elemento))

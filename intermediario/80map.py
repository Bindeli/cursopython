...
Nesta aula foi criado o arquivo em py chamado de "dados" na pasta intermediario
Agora vamos importar dados de outros arquivos

Também foi criado o arquivo "mapeamento"
E agora vamos começar a trabalhar no arquivo
"""

# --------------------------------------------------------------------------------------------------
# para eu puxar os dados para o mapeamento, eu irei utilizar

from dados import produtos, pessoas, lista

# eu puxo os dados do arquivo

# vou utilizar um print para verificar se o dado foi puxado
print(f'\nPrintando a lista: {lista}')
print(f'Printando o dicionario de produtos: {produtos}')
print(f'Printando o dicionario de pessoas : {pessoas}')
